...
let ActivityLogsController = class ActivityLogsController {
    ...
    findAll(page, limit, action, entityType, userId) {
        return this.service.findAll(Number(page) || 1, Math.min(Number(limit) || 50, 100), { action, entityType, userId: userId ? Number(userId) : undefined });
    }
    getActions() {
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], ActivityLogsController.prototype, "getActions", null);
__decorate([
    (0, common_1.Get)('entity-types'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
], ActivityLogsController.prototype, "getEntityTypes", null);
__decorate([
    (0, common_1.Get)('cleanup'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
], ActivityLogsController.prototype, "cleanup", null);
