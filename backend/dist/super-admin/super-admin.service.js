...
let SuperAdminService = class SuperAdminService {
    constructor(usersRepository, emailService, tenantsService, kycService) {
    ...
    async getDashboard() {
        ...
        const admins = await this.usersRepository.count({ where: { role: user_entity_1.UserRole.ADMIN_TENANT } });
        const freelancers = await this.usersRepository.count({ where: { role: user_entity_1.UserRole.FREELANCE } });
