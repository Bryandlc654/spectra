...
exports.ContractsModule = ContractsModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([contract_template_entity_1.ContractTemplate, contract_entity_1.Contract])],
        controllers: [contracts_controller_1.ContractsController],
        providers: [contract_templates_service_1.ContractTemplatesService, contracts_service_1.ContractsService],
        exports: [contract_templates_service_1.ContractTemplatesService, contracts_service_1.ContractsService],
    })
], ContractsModule);
