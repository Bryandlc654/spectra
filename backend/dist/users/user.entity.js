...
(function (UserRole) {
    ...
    UserRole["ADMIN_TENANT"] = "admin_tenant";
...
__decorate([
    (0, typeorm_1.Column)({ nullable: true }),
    __metadata("design:type", String)
], User.prototype, "documentId", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => area_entity_1.Area, { nullable: true }),
...
], User.prototype, "invitationExpires", void 0);
__decorate([
